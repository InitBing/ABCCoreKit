...
@property(nonatomic, strong) ABCBaseManager *linvingManager;
 ...
 *  @param image    UIImage
 */
-(void) addWhiteBoardImage:(NSString *) imageUrl imageData:(UIImage *) image;
 ...
 *  @param fileUrl   云盘地址
 */
-(void)addPDFWithLocalPath:(NSString *) localPath fileUrl:(NSString *) fileUrl;
