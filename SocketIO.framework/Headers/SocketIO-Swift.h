...
/// returns:
/// a public key
- (SecKeyRef _Nullable)extractPublicKey:(NSData * _Nonnull)data SWIFT_WARN_UNUSED_RESULT;
...
/// returns:
/// a public key
- (SecKeyRef _Nullable)extractPublicKeyFromCert:(SecCertificateRef _Nonnull)cert policy:(SecPolicyRef _Nonnull)policy SWIFT_WARN_UNUSED_RESULT;
...
- (NSArray<NSData *> * _Nonnull)certificateChainForTrust:(SecTrustRef _Nonnull)trust SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end
